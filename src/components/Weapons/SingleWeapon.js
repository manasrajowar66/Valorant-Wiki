            ...
            <div className={classes["weapon-details"]}>
                ...
                <div className={classes["dropdown-container"]}>
                    ...
                    <select onChange={onChangeHandler} value={selectedSkin}>
                        ...
                        {weaponDetails && weaponDetails.skins.map((skin, index) => {
                            if (skin.displayIcon) {
                                return (
                                    <option
                                        value={index}
                    ...
                    <>
                        <div className={classes.variants}>
                            ...
                            {variants.map((chroma, index) => {
                                if (chroma.swatch) {
                                    return (
                                        <div
                                            className={`${selectedVariant === index && classes["active-variant"]
                                                }`}
                        ...
                        <div className={classes["selected-variant"]}>
                            <img
                                ...
                                alt=''
                            />
                            <h1 className={`${toggle && classes.zoom}`}>{variants[selectedVariant].displayName}</h1>
                        </div>
                    </>
                )}
            </div>
